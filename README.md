...
2. **Clone this repository.** - `git clone https://github.com/saeeds/nodeStarterKit.git` or [download the zip](https://github.com/coryhouse/javascript-development-environment/archive/master.zip)
